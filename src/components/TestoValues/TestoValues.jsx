  ...
  <div className='sfondo-testo'>
    <div className="text-container">
      ...
      <div className="paragrafo">
        ...
        <div className="paragrafo">
        <h2>Integrity as the Key to Trust</h2>
      </div>
        <div className="paragrafo">
