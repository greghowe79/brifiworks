...
const TestoCompetencies= () => (
	<div className='sfondo-testo'>
		...
		We love what we do. We develop a content strategy, curate, and create content with a narrative that rings true for our clients’ target audience or market, no matter the medium.
		</div>
		<div className="paragrafo">
